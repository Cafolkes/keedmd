...
if not load_fit:
    ...
    if load_diffeomorphism_model:
        ...
        xk, xk_dot, q_d, tk = eigenfunction_basis.process(X=xs, t=t_eval, X_d=q_d)
        eigenfunction_basis.fit_diffeomorphism_model(X=xk, X_dot=xk_dot, X_d=q_d, l2=l2_diffeomorphism, jacobian_penalty=jacobian_penalty_diffeomorphism,
